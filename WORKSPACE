...
# bazel run @io_bazel_rules_dotnet//tools/nuget2bazel:nuget2bazel.exe -- add -l system.runtime.compilerservices.unsafe 4.7.1 -d C:/path/to/rules_dotnet_assembly_references
